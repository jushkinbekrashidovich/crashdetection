...
class AppColors {
  ...
  static const mainColor = Color(0xff3626A7); 
  static const secondaryColor = Color(0xff7365E0); 
  static const background = Color(0xffF4F6F9);
  static const backgroundButton = Color(0xffEFEDFB);

  static const white = Color(0xFFffffff);
  static const black = Color(0xFF000000);
  
  static const greyColor = Color.fromARGB(255, 189, 204, 216);
  static const orangeColor = Color(0xffE59407);
